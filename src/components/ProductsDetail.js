...
class ProductsDetail extends React.Component {
    ...
    componentDidMount() {
        ...
        axios.get(`https://c24bintegrador.ngrok.io/productos/categorias/` + cAux)
            .then(res => {
            ...
            <section id="portfolio">
                <div class="container ">
                    ...
                    <header class="section-header">
                        <h3 class="section-title">Productos de la categoria</h3>
                    </header>
                    <div class="container-fluid mt-3 text-center wow fadeInUp" >
                        <div class="row">
